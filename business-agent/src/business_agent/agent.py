...
root_agent = Agent(
    ...
    instruction=(
        ...
        " The catalog spans six sectors: consumer goods, fresh foods, foodservice,"
        " apparel, healthcare and construction. When the user asks about any product detail — for"
